# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 10:36:42 2023
...
def trade_one(chro, df, money, ta):
   #print(df)
    ...
    if rows_in_df(df['涨跌额'],this_1['涨跌额']) == True:
        ...
        df2 = this_1
        B = 1/0.012016063811404057 # 假设B为2，可以根据实际情况调整,注意反转情况
        ...
        if state == 0:
            ...
            if stop_signal and i != len(df)-1: # 停損停利
                ...
                while state == 1:       
                    ...
                    p1,r1 = get_stock_profit(treasury_stock2[-1],next_price_df2)
                    profit.append(p)
                    rr.append(r)
                    account += p
                    profit.append(p1)
                    ...
                    if MARK == 9:
                        ...
                        p1,r1 = get_stock_profit(treasury_stock2.pop(),next_price_df2)
                        profit.append(p)
                        rr.append(r)
                        account += p
                        profit.append(p1)
                        ...
                        p1,r1 = get_short_stock_profit2(treasury_stock2.pop(),next_price_df2)
                        profit.append(p)
                        rr.append(r)
                        account += p
                        profit.append(p1)
                ...
                while state == 1:
                    ...
                    p1,r1 = get_stock_profit(treasury_stock2[-1],current_price_df2)
                    profit.append(p)
                    rr.append(r)
                    account += p
                    profit.append(p1)
        ...
        if state == 0:
            ...
            if stop_signal and i != len(df)-1: # 停損停利
                ...
                while state == 1:       
                    ...
                    account += p1
                    if MARK == 9:
                        p, r = get_short_stock_profit2(treasury_stock[-1], next_price)
                        p1,r1 = get_stock_profit3(treasury_stock2[-1],next_price_df2,B)
                        profit.append(p)
                        rr.append(r)
                        account += p
                        ...
                        p, r = get_stock_profit(treasury_stock[-1], next_price)
                        p1,r1 = get_short_stock_profit4(treasury_stock2[-1],next_price_df2,B)
                        profit.append(p)
                        rr.append(r)
                        account += p
                        profit.append(p1)
